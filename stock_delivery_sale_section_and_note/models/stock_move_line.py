...
class StockMoveLine(models.Model):
    ...
    def _aggregate_sections_and_notes(
        self, aggregated_move_lines, done_line_keys
    ):
        ...
        while previous_record:
            ...
            if line_key not in done_line_keys:
                if previous_record.is_section_or_note():
                    values = self.prepare_section_or_note_values(
                        previous_record
                    )
    ...
    def _reordered_aggregated_product_quantities(self, **kwargs):
        ...
        """
        super_aggregated_move_lines = (
            super()._get_aggregated_product_quantities(**kwargs)
        )
    ...
    def _get_aggregated_product_quantities(self, **kwargs):
        ...
        """
        aggregated_move_lines = self._reordered_aggregated_product_quantities(
            **kwargs
        )
